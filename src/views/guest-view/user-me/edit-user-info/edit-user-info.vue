<template>
  <div class="add-personal-data">
    ...
    <div class="EU-warn" v-show="nameWarn">
    ...
    <transition name='fade'>
    <div class="EU-warn" v-show="phoneWarn">
      <img src="./img/警告.png" alt="">
      <div>请正确填写电话</div>
    </div>
    </transition>
    ...
    <transition name='fade'>
    <div class="EU-warn" v-show="addressWarn">
      <img src="./img/警告.png" alt="">
    ...
    <transition name='fade'>
    <div class="EU-warn" v-show="allWarn">
      <img src="./img/警告.png" alt="">
