<template>
<div class="MN-bg" :style="{width:winW+'px',height:winH+'px'}" @click.self="backHandle">
  ...
  <div class="add-personal-data">
    ...
    <div class="EI-warn" v-show="nameWarn">
    ...
    <transition name='fade'>
    <div class="EI-warn" v-show="phoneWarn">
      <img src="./img/警告.png" alt="">
      <div>请正确填写电话</div>
    </div>
    </transition>
    ...
    <transition name='fade'>
    <div class="EI-warn" v-show="addressWarn">
      <img src="./img/警告.png" alt="">
    ...
    <transition name='fade'>
    <div class="EI-warn" v-show="allWarn">
      <img src="./img/警告.png" alt="">
...
export default {
  ...
  created(){
    this.name = this.userInfo.name2
    this.phone = this.userInfo.phone2
    this.address = this.userInfo.address2
    this.defaultAddress = this.userInfo.isDefaule2
  },
  props:{
    userInfo:{
      type:Object,
